...
define('APP_ID', 'local.5e709c8eaaecf4.42197745'); // take it from Bitrix24 after adding a new application
define('APP_SECRET_CODE', 'eB02M9RY77r2ObSyblQNxRVxDLFhufRWCgeaH1ZFIrOAL6eytu'); // take it from Bitrix24 after adding a new application
define('APP_REG_URL', 'http://localhost:8081/source/index.php'); // the same URL you should set when adding a new application in Bitrix24
